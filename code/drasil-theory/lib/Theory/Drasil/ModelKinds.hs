...
import Language.Drasil (NamedIdea(..), NP, QDefinition, Expr, DifferentialModel,
...
newDEModel' dm = MK (NewDEModel dm) (uid dm) (dm ^. term)
...
instance HasUID (ModelKinds e) where uid = elimMk (to uid) (to uid) (to uid) (to uid) (to uid)
--  uid (DEModel x) = uid x
...
instance HasChunkRefs e => HasChunkRefs  (ModelKinds e) where chunkRefs = elimMk (to chunkRefs) (to chunkRefs) (to chunkRefs) (to chunkRefs) (to chunkRefs)
