...
doccon = [abbAcc, abbreviation, acronym, analysis, appendix, aspect, body,
  ...
  endUser, environment, example, failure, figure, first, form, full, fullForm,
  functional, functionalRequirement, game, general, generalSystemDescription,
  goal, guide, implementation, inDatumConstraint, indPRCase, individual,
  information, input_, instance_, intReader, interest, interface, introduction,
  issue, item, label, library, limitation, literacy, loss, mainIdea, material_,
  message, methAndAnls, method_, model, module_, name_, nonfunctional,
  nonfunctionalRequirement, object, offShelf, offShelfSolution, open, orgOfDoc,
  organization, outDatumConstraint, output_, physical, physicalConstraint,
  physicalProperty, physicalSim, physicalSystem, physics, plan, practice,
  priority, problem, problemDescription, problemIntro, procForAnls, procedure,
  prodUCTable, productUC, product_, project, propOfCorSol, property, prpsOfDoc,
  purpose, quantity, realtime, refMat, reference, reqInput, requirement_,
  response, result, review, reviewer, safety, safetyReq, scenario, scope,
  scpOfReq, scpOfTheProjS, second_, section_, simulation, software,
  softwareConstraint, softwareDoc, softwareReq, softwareSys, softwareVAV,
  softwareVerif, solution, solutionCharSpec, solutionCharacteristic, source,
  specific, specification, specificsystemdescription, stakeholder, standard,
  statement, summary, symbol_, sysCont, system, systemConstraint,
  systemdescription, tAuxConsts, tOfCont, tOfSymb, tOfUnit, table_, task,
  template, termAndDef, term_, terminology, theory, third, traceyGraph,
