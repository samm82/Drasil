...
def test_valid_func_t_flight(filename, t_flight):
...
def test_valid_func_p_land(filename, p_land):
    inParams = read_inParams(filename)
...
def test_valid_func_d_offset(filename, d_offset):
    inParams = read_inParams(filename)
...
def test_valid_func_s(filename, d_offset, s):
    inParams = read_inParams(filename)
