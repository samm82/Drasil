...
\\
${c_{i}}$ & Entry of a generic compound & --
\\
...
\\ \midrule \\
RefBy & \hyperref[DD:compoundType]{DD:compoundType}
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule \\
Notes & A type representing a compound where an entry ${c_{i}}$ represents how many atoms of the $i$-th element of $E$ (from \hyperref[DD:elementType]{DD:elementType}) are present in the compound.
...
\hyperref[DD:elementType]{DD:elementType} &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:compoundType]{DD:compoundType} & X &  &  &  &  &  &  &  & 
\\
\hyperref[DD:reactionType]{DD:reactionType} &  &  &  &  &  &  &  &  & 
\\
\hyperref[DD:countFunc]{DD:countFunc} &  &  &  &  &  &  &  &  & 
