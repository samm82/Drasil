...
\\ \midrule \\
Equation & \begin{displaymath}
           \text{elems}=\{e\in{}E\text{ | }\exists{}\,c\in{}C,y\in{}\mathbb{Z},x\in{}\mathbb{Z}\text{ | }y=x\}
           \end{displaymath}
\\ \midrule \\
Description & \begin{symbDescription}
              ...
              \item{$x$ is the generic integer (Unitless)}
              \end{symbDescription}
\\ \midrule \\
